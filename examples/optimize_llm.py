#!/usr/bin/env python
"""Example script demonstrating how to use SparseOpt with HuggingFace models."""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Optimize a HuggingFace model with SparseOpt")
